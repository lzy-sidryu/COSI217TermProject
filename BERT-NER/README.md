...
`python run_ner.py --data_dir=esports_data/ --bert_model=bert-base-cased --task_name=ner --output_dir=out_esports --max_seq_length=128 --do_train --num_train_epochs 5 --do_eval --eval_on test --warmup_proportion=0.1`
